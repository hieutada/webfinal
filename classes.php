...
<body>
    ...
    <div class="tab-content container" id="myTabContent">
        ...
        <div class="tab-pane fade mt-3" id="people" role="tabpanel" aria-labelledby="people-tab">
            <!-- teacher -->
            <div class="h4 font-weight-normal text-primary">Teacher</div> <hr>
            ...
            <br><br>
            <!-- classmate -->
            <span class="h4 font-weight-normal text-primary mr-2">Classmates</span><span class="align-self-center">(2 Students)</span><hr>
